...
enum my_keyball_keycodes {
    ...
    PRC_TOG,                      // Precision モードトグル REMAP User 1 キーで設定
    PRC_SW,                       // Precision モードスイッチ REMAP User 2 キーで設定
};
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    // マウス自動レイヤー切り替えの除外設定 特に除外したいレイヤーがないのでコメントアウト
